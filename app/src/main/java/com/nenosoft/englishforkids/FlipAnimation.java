...
public class FlipAnimation extends Animation { 
	 ...
	 * @param scaleType flip view transition is broken down into two: the zoom-out of the "from" view and the zoom-in of the "to" view. This parameter is used to determine which is being done. See {@link com.nenosoft.poems.englishforkids.FlipAnimation.ScaleUpDownEnum}.
	 */
	...
	/**
	 * This enumeration is used to determine the zoom (or scale) behavior of a {@link com.nenosoft.poems.englishforkids.FlipAnimation}.
	 * 
	 * @author Ephraim A. Tekle 
	 *
	 */
